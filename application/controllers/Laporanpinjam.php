...
class Laporanpinjam extends CI_Controller
{
	...
	{	
		...
		$this->load->view('cetakpinjam/laporan_view',$this->data);
		$this->load->view('footer_view',$this->data);
    } 
    public function cetak()
    {
        $this->data['user'] = $this->M_Admin->get_table('tbl_login');
		$this->data['pinjam'] = $this->M_Admin->get_pinjamm('tbl_pinjam');
		$this->load->view('cetakpinjam/pdf_print',$this->data);
    ...
    public function cetakpinjam()
	{
		...
		$this->load->view('header_view',$this->data);
		$this->load->view('sidebar_view',$this->data);
		$this->load->view('cetakpinjam/detail',$this->data);
		$this->load->view('footer_view',$this->data);
	}
