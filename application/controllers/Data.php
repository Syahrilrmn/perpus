...
class Data extends CI_Controller {
	...
	public function bukudetail()
	{
		...
		if($count > 0)
		{
			...
			$this->data['kats'] =  $this->db->query("SELECT * FROM tbl_kategori ORDER BY id_kategori ASC")->result_array();
			$this->data['rakbuku'] =  $this->db->query("SELECT * FROM tbl_rak ORDER BY id_rak ASC")->result_array();
	...
	public function prosesbuku()
	{
		...
		if(!empty($this->input->post('tambah')))
		{
			...
			$buku_id = $this->M_Admin->buat_kode('tbl_buku','BK','id_buku','ORDER BY id_buku ASC LIMIT 1'); 
			$data = array(
				'buku_id'=>$buku_id,
	...
	public function kategori()
	{
        ...
        $this->data['idbo'] = $this->session->userdata('ses_id');
		$this->data['kategori'] =  $this->db->query("SELECT * FROM tbl_kategori ORDER BY id_kategori ASC");
	...
	public function rak()
	{
        ...
        $this->data['idbo'] = $this->session->userdata('ses_id');
		$this->data['rakbuku'] =  $this->db->query("SELECT * FROM tbl_rak ORDER BY id_rak ASC");
