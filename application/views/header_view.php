  ...
  <div class="wrapper">
    <header class="main-header">
      ...
      <a href="<?php echo base_url('index.php/dashboard'); ?>" class="logo">
        ...
        <span class="logo-mini"><b>P</b>LN</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg">
          <i class="fa-solid fa-bolt" style="padding-right: 10px;"></i>Perpus UPT</span>
      </a>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <span><?php echo $d->nama;
                      ?> <i class="caret"></i></span>
              </a>
              <ul class="dropdown-menu">
                <!-- User image -->
                <li class="user-header bg-light-blue">
                  <img src="<?php echo base_url(); ?>assets_style/image/<?php echo $d->foto; ?>" class="img-circle" alt="User Image" />
                  <p>
                    <?php echo $d->nama;
                    ?>
                    <small><?php echo $d->level;
                      ?></small>
                  </p>
                </li>
                ...
                <li class="user-footer">
                  <div class="pull-left">
                    <a href="<?= base_url('user/edit/' . $idbo); ?>" class="btn btn-default btn-flat">Profile</a>
                  </div>
