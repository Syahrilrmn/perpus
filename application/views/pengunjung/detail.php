...
?>
<?php
        $tgla = $pengunjung->tgl_kunjung;
        $tglk = $pengunjung->tgl_lahir;
        $bulan = array(
            '01' => 'Januari',
            '02' => 'Februari',
            '03' => 'Maret',
            ...
            <page size="A4">
				<div class="panel panel-default">
					<div class="panel-body bg-primary">
						<h4 class="text-center">KARTU PENGUNJUNG PERPUSTAKAAN</h4>
						<br/>
						<div class="row">
							<div class="col-sm-8">
								<table class="table table-stripped">
									<tr>
										<td>ID Pengunjung</td>
										<td>:</td>
										<td><?= $pengunjung->pengunjung_id;?></td>
									</tr>
									<tr>
										<td>Nama</td>
										<td>:</td>
									...
									<!-- <tr>
										<td>TTL</td>
										<td>:</td>
										<td><?= $pengunjung->tempat_lahir;?>, <?= $tgl2 ;?></td>
									</tr> -->
									<tr>
										<td>jenkel</td>
										<td>:</td>
										<td><?= $pengunjung->jenkel;?></td>
									</tr>
                                    <tr>
										<td>Perlu</td>
										<td>:</td>
										<td><?= $pengunjung->perlu;?></td>
									</tr>
                                    <tr>
										<td>Cari</td>
										<td>:</td>
