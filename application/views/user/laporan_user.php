	    ...
	    <div class="col-md-12">
	        <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <a href="user/cetak"><button class="btn btn-info" style="font-size: 16px; "><i class="fa-sharp fa-solid fa-file-pdf" style="font-size: 20px; "></i><span style="padding-left: 15px;">Import Pdf</span> </button></a>
