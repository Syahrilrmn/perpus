...
?>
<?php
        $tgla = $anggota->tgl_bergabung;
        $tglk = $anggota->tgl_lahir;
        $bulan = array(
            '01' => 'Januari',
            '02' => 'Februari',
            '03' => 'Maret',
					...
					<div class="panel-body bg-primary">
						...
						<div class="row">
							<div class="col-sm-8">
								<table class="table table-stripped">
									...
									<tr>
										<td>TTL</td>
										<td>:</td>
										<td><?= $anggota->tempat_lahir;?>, <?= $tgl2 ;?></td>
									</tr>
									<tr>
										<td>Alamat</td>
										<td>:</td>
							...
							<div class="col-sm-4 text-center">
								<center>
									<img src="<?php echo base_url();?>assets_style/image/<?php echo $anggota->foto;?>" style="width:3cm;height:4cm;" class="img-responsive">
								</center>
							</div>
						</div>
					</div>
